...
export default function SavingsCalculator() {
  ...
  return (
    <div className="bg-white border border-brand-border rounded-md p-6 sm:p-8 lg:p-10 shadow-card">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-6 space-y-6">
          <div className="space-y-3 bg-brand-warmWhite p-5 rounded border border-brand-border">
            <div className="flex items-center justify-between">
              <label className="text-xs font-bold uppercase tracking-wider text-brand-charcoal">
                {t.dailyKmLabel}
              </label>
              <span className="text-lg font-black text-brand-red font-mono px-2.5 py-0.5 rounded bg-brand-lightRed border border-brand-red/30">
                {km} km
              </span>
            </div>
            <input
            ...
            />
            <div className="flex justify-between text-[11px] text-brand-muted font-bold">
              <span>60 km</span>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-4 rounded bg-brand-cream border border-brand-border space-y-1">
              <span className="text-[11px] font-bold uppercase text-brand-muted">
                {t.dieselCostLabel}
              </span>
              <div className="text-xl font-black text-brand-charcoal">₹{dieselDaily} {t.perDaySuffix}</div>
              <div className="text-[10px] text-brand-muted">{t.dieselRate}</div>
            </div>

            <div className="p-4 rounded bg-brand-lightRed/50 border border-brand-red/30 space-y-1">
              <span className="text-[11px] font-bold uppercase text-brand-red">
                {t.electricCostLabel}
              </span>
              <div className="text-xl font-black text-brand-red">₹{electricDaily} {t.perDaySuffix}</div>
              <div className="text-[10px] text-brand-red font-semibold">{t.electricRate}</div>
            </div>
          </div>
        </div>

        <div className="lg:col-span-6 bg-gradient-to-br from-brand-charcoal to-brand-charcoalSoft text-white p-6 sm:p-8 rounded-md space-y-5 shadow-elevated">
          <div>
            ...
            <div className="text-4xl sm:text-5xl font-black text-white mt-1 tracking-tight">
              ...
              <span className="text-sm sm:text-base font-normal text-[#D6D1C7] ml-2">
                {t.perMonthSuffix}
              </span>
            </div>
          </div>
          ...
          <div className="pt-3 border-t border-white/10 grid grid-cols-2 gap-4">
            <div>
              <span className="text-[11px] uppercase tracking-wide text-[#A8A296]">
                {t.dailySavingsLabel}
              </span>
              <div className="text-lg font-bold text-brand-yellow mt-0.5">
