...
export const vehiclesData: Vehicle[] = [
  {
    ...
    fullDescriptionHi: "भारी दैनिक व्यावसायिक आवागमन के लिए विशेष रूप से निर्मित, सरगम विक्टर ई-रिक्शा चालकों को अत्यंत कम संचालन खर्च और सवारियों को आरामदायक व स्थिर सफर देता है। मजबूत स्टील चेसिस और भारी सस्पेंशन से युक्त।",
  ...
  },
  {
    ...
    fullDescription: "The King Cargo Express is built for local merchants, couriers, hardware suppliers, and wholesale transport across Jalandhar and neighboring mandis. It cuts running expenses down to a fraction of diesel or petrol cargo three-wheelers while offering high reliability.",
  ...
  {
    id: "mkb-deluxe-passenger",
    slug: "mkb-deluxe-passenger",
    name: "MKB Deluxe Passenger E-Rickshaw",
    nameHi: "एमकेबी डीलक्स पैसेंजर ई-रिक्शा",
    series: "Deluxe Passenger Series",
    seriesHi: "डीलक्स पैसेंजर सीरीज",
    category: "Passenger",
    categoryHi: "पैसेंजर ई-रिक्शा",
    tagline: "Premium passenger electric three-wheeler built for maximum comfort and long operating range.",
    taglineHi: "अधिकतम आराम और लंबी रेंज के लिए निर्मित प्रीमियम पैसेंजर ई-रिक्शा।",
    shortDescription: "Heavy-duty electric passenger vehicle with heavy alloy wheels, cushioned premium rexine seats, and extended battery range.",
    shortDescriptionHi: "मजबूत अलॉय व्हील, प्रीमियम कुशन सीट और लंबी बैटरी रेंज वाला लोकप्रिय पैसेंजर ई-रिक्शा।",
    fullDescription: "The MKB Deluxe Passenger E-Rickshaw is engineered for reliable, non-stop passenger ferrying across Jalandhar and Punjab routes. It features an ultra-reinforced steel frame, long-lasting suspension, and low daily charging costs.",
    fullDescriptionHi: "जालंधर और पंजाब के सवारी रूटों पर बिना रुकावट लगातार चलने के लिए विशेष निर्मित एमकेबी डीलक्स ई-रिक्शा। मजबूत स्टील बॉडी और कम चार्जिंग खर्च।",
    priceNote: "Government EV subsidy may apply. Contact Balaji Motors for exact quotation.",
    priceNoteHi: "सरकारी सब्सिडी लागू हो सकती है। सही कीमत के लिए बालाजी मोटर्स से संपर्क करें।",
    approximateStartingPrice: "Price on Enquiry",
    approximateStartingPriceHi: "कीमत पूछताछ पर",
    available: true,
    featured: true,
    badges: ["Deluxe Comfort", "Alloy Wheels", "High Range"],
    badgesHi: ["डीलक्स कम्फर्ट", "अलॉय व्हील", "लंबी रेंज"],
    image: "/images/rickshaw-white.webp",
    gallery: [
      "/images/rickshaw-white.webp",
      "/images/rickshaw-blue.webp",
    ...
    specs: {
      motor: "High Torque Commercial BLDC Motor",
      batteryType: "Lead-Acid / Advanced Lithium-Ion Option",
      batteryCapacity: "Configurable per route requirements",
      rangePerCharge: "85 - 110 km per single charge",
      chargingTime: "4 - 8 Hours depending on battery system",
      seatingCapacity: "Driver + 4 Passengers (CMVR Approved)",
      topSpeed: "25 km/h",
      brakes: "Front & Rear Mechanical Drum Brakes",
      chassisFrame: "Ultra-Reinforced Tubular Steel Structure",
      warranty: "Manufacturer Warranty on Motor & Controller",
    },
    specsHi: {
      motor: "हाई टॉर्क बीएलडीसी मोटर",
      batteryType: "लेड-एसिड / आधुनिक लिथियम-आयन विकल्प",
      batteryCapacity: "रूट अनुसार चयन योग्य",
      rangePerCharge: "85 - 110 किमी प्रति सिंगल चार्ज",
      chargingTime: "4 - 8 घंटे (बैटरी अनुसार)",
      seatingCapacity: "चालक + 4 सवारी (सरकारी अनुमोदित)",
      topSpeed: "25 किमी/घंटा",
      brakes: "अगले व पिछले ड्रम ब्रेक",
      chassisFrame: "मजबूत ट्यूबलर स्टील चेसिस",
      warranty: "मोटर व कंट्रोलर पर निर्माता वारंटी",
    },
    colors: [
      { name: "Pure White", nameHi: "प्योर व्हाइट", hex: "#E5E7EB", image: "/images/rickshaw-white.webp" },
      { name: "Dealership Red", nameHi: "डीलशिप रेड", hex: "#C9232A", image: "/images/rickshaw-red.webp" },
    ...
    hotspots: [
      {
        ...
        title: "Commercial Powertrain",
        titleHi: "कमर्शियल मोटर",
        description: "Heavy-duty electric powertrain delivering strong torque for passenger hauling.",
        descriptionHi: "सवारियों को बिना रुकावट ढोने के लिए शक्तिशाली इलेक्ट्रिक मोटर।",
        top: "70%",
        left: "22%",
      },
      {
        id: "cabin",
        title: "Deluxe Passenger Cabin",
        titleHi: "डीलक्स पैसेंजर केबिन",
        description: "High-density foam seating with premium weatherproof upholstery.",
        descriptionHi: "प्रीमियम वेदरप्रूफ सीटों के साथ आरामदायक सफर।",
        top: "48%",
        left: "65%",
      },
    ],
    featuresList: [
      "Heavy-duty alloy wheels with anti-skid commercial tyres",
      "Reinforced roof frame with all-weather protective shields",
      "Digital speedometer and accurate battery indicator",
      "Smooth front telescopic and rear heavy leaf-spring suspension",
      "Low per-kilometer running expense",
      "On-the-spot finance assistance with leading banks at showroom",
    ],
    featuresListHi: [
      "एंटी-स्किड टायरों के साथ मजबूत अलॉय व्हील",
      "हर मौसम से सुरक्षा वाली मजबूत छत व साइड कर्टन",
      "डिजिटल स्पीडोमीटर व बैटरी इंडिकेटर",
      "झटका-मुक्त फ्रंट टेलीस्कोपिक व रियर कमानी सस्पेंशन",
      "अत्यंत कम प्रति-किलोमीटर रनिंग खर्च",
      "शोरूम पर ही प्रमुख बैंकों से आसान लोन सुविधा",
    ],
  },
];
